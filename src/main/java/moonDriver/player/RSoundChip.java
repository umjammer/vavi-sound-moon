...
package moonDriver.player;
    ...
    public class RSoundChip
    {
        ...
        virtual public boolean isBufferEmpty()
        {
            throw new UnsupportedOperationException();
        }

        virtual public int SetMasterClock(int mClock)
        {
            throw new UnsupportedOperationException();
        }
    ...
    public class RScciSoundChip : RSoundChip
    {
        ...
        public RScciSoundChip(int soundLocation, int busID, int soundChip) : super(soundLocation, busID, soundChip)
        {
        }
        ...
        override public int SetMasterClock(int mClock)
        {
            //SCCIはクロックの変更不可
    ...
    public class RC86ctlSoundChip : RSoundChip
    {
        ...
        public RC86ctlSoundChip(int soundLocation, int busID, int soundChip) : super(soundLocation, busID, soundChip)
        {
        }
